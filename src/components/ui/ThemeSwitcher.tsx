  ...
  return (
    <div className="relative group">
      <button
        ...
        onClick={toggleTheme}
        aria-label={label}
        className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-surface-raised hover:bg-surface-raised border-2 border-line hover:border-accent shadow-sm sm:shadow-md flex items-center justify-center cursor-pointer transition-[transform,border-color,box-shadow] duration-150 hover:scale-105 active:scale-95 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary p-0 m-0"
      >
